...
using GameInteraction.Domain.DomainEvents.PlayerDomainEvents;
using GameInteraction.Domain.Enums;
using GameInteraction.Domain.Messages;
using JsonSerializer = System.Text.Json.JsonSerializer;
using Room = GameInteraction.Domain.Entities.RoomEntity.Room;
...
public sealed partial class Player : Entity, IHasDomainEvent
{
    ...
    public void SetMoveStatus(EMoveStatus moveStatus)  // TODO: make private/internal
    {
